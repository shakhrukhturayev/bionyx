  ...
  return (
    ...
    <section className="bg-white dark:bg-lightBlue">        
      <div className="mx-auto max-w-screen-sm">
          <h2 className="mb-4 py-10 w-full uppercase sm:text-4xl text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white flex justify-center  text-center items-center">Mutaxasislardan maslahatlar</h2>
